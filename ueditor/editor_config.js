...
(function () {
    ...
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            [	'FullScreen', 'Source', '|', 									//全屏，源代码
             	'Undo', 'Redo', '|',												//撤销，重做
                'Bold', 'Italic', 'Underline', 									//加粗，斜体，下划线
                'Superscript', 'Subscript', 									//上标，下标
                'RemoveFormat', 'FormatMatch','AutoTypeSet', '|',	//清除格式，格式刷，自动排版
                'PastePlain', '|', 												//纯文本黏贴
                'ForeColor', 'BackColor', 										//字体颜色，背景色
                'InsertOrderedList','InsertUnorderedList',				//有序列表，无序列表
                'SelectAll', 'ClearDoc', '|', 									//全选，清空文档
                'CustomStyle','Paragraph', '|',								//自定义样式，段落
                'RowSpacingTop', 'RowSpacingBottom','LineHeight', '|',//段前间距，段后间距，行间距
                'FontFamily', 'FontSize', '|',									//字体，字号
                //'DirectionalityLtr', 'DirectionalityRtl', '|', 				//从左向右输入，从右向左输入
                '', 'Indent', '|',													//首行缩进
                'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyJustify', '|',//四种对齐
                'Link', 'Unlink', 'Anchor', '|', 								//超链接，取消超链接，锚
                'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', //图片对齐方式
                'InsertImage', 'Emotion', 'InsertVideo', 'Attachment', //插入图片，表情，视频，附件
                //'Map', 'GMap', 												//插入地图
                'InsertFrame', 'PageBreak', 'Horizontal', 				//插入Frame，分页，分割线
                //'HighlightCode', 												//插入代码
                '|',	'Date', 'Time', 'Spechars', '|',							//日期，时间，特殊字符
                
                'InsertTable', 'DeleteTable', 'InsertParagraphBeforeTable', //表格相关
                'InsertRow', 'DeleteRow', 'InsertCol', 'DeleteCol', 
                'MergeCells', 'MergeRight', 'MergeDown', 
                'SplittoCells', 'SplittoRows', 'SplittoCols', '|',
                 'Print', 'Preview', 'SearchReplace','Help']				//打印，预览，查询替换，帮助
        ],
